...
> Form Validator is an advanced website created with HTML, SCSS, and JavaScript, built using webpack. While I opted not to use linters due to the presence of SCSS, I invite you to explore the live demo for a firsthand experience.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Form-Validator/dist/index.html)
